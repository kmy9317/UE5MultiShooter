...
void AShotgun::FireShotgun(const TArray<FVector_NetQuantize>& HitTargets)
{
	...
	if (MuzzleFlashSocket)
	{
		...
		// Calculate bodyshot damage by multiplying times hit * Damage (Store in DamageMap)
		...
		// Calculate head shot damage by multiplying times hit * Damage (Store in DamageMap)
